...
#ifndef __USB_HID_KBD_H
#define __USB_HID_KBD_H
...
//FIXME make them specific to kbd

//const extern usb_endp_desc_t hid_endp_desc[];
//const extern hid_descriptor_t hid_descriptor;

#define HID_KBD_INTERFACE(iface,istring) \
{ \
...
extern const usb_profile_t usb_hid_kbd;
 ...
 ************************************************************
 ...
 ASCII code  : https://fr.wikipedia.org/wiki/American_Standard_Code_for_Information_Interchange

 ************************************************************

 Keyboard - Modifier Keys (byte 0)
 ...
 ************************************************************
 ...
 Keyboard - keys (byte 2)  => http://www.freebsddiary.org/APC/usb_hid_usages.php
