...
typedef enum
{
    RCC_SYSCLK_MCO2_CLOCK_SYSCLK = 0x0,
    RCC_SYSCLK_MCO2_CLOCK_PLLI2S = 0x1,
    RCC_SYSCLK_MCO2_CLOCK_HSE = 0x2,
    RCC_SYSCLK_MCO2_CLOCK_PLL = 0x3
} rcc_sysclk_mco2_clock_t;

typedef enum
{
    RCC_SYSCLK_MCO1_CLOCK_HSI = 0x0,
    RCC_SYSCLK_MCO1_CLOCK_LSE = 0x1,
    RCC_SYSCLK_MCO1_CLOCK_HSE = 0x2,
    RCC_SYSCLK_MCO1_CLOCK_PLL = 0x7
} rcc_sysclk_mco1_clock_t;
