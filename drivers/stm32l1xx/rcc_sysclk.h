...
{
    RCC_SYSCLK_SOURCE_MSI = 0,
    RCC_SYSCLK_SOURCE_HSI = 1,
    RCC_SYSCLK_SOURCE_HSE = 2,
    RCC_SYSCLK_SOURCE_PLL = 3
} rcc_sysclk_source_t;

typedef enum rcc_sysclk_clock
{
...
typedef enum rcc_sysclk_ahb_prescaler
{
...
typedef enum rcc_sysclk_apb_prescaler
{
...
typedef enum
{
    ...
    RCC_SYSCLK_MCO_CLOCK_SYSCLK = 0x1,
    RCC_SYSCLK_MCO_CLOCK_HSI = 0x2,
    RCC_SYSCLK_MCO_CLOCK_MSI = 0x3,
    RCC_SYSCLK_MCO_CLOCK_HSE = 0x4,
    RCC_SYSCLK_MCO_CLOCK_PLL = 0x5,
    RCC_SYSCLK_MCO_CLOCK_LSI = 0x6,
    RCC_SYSCLK_MCO_CLOCK_LSE = 0x7
} rcc_sysclk_mco_clock_t;

typedef enum
{
    RCC_SYSCLK_MCO_PRE_1 = 0x0,
    RCC_SYSCLK_MCO_PRE_2 = 0x1,
    RCC_SYSCLK_MCO_PRE_4 = 0x2,
    RCC_SYSCLK_MCO_PRE_8 = 0x3,
    RCC_SYSCLK_MCO_PRE_16 = 0x4,
} rcc_sysclk_mco_pre_t;
...
/**
 * Set all clock parameters at once.
 */
void rcc_sysclk_set(rcc_sysclk_source_t source,
                    rcc_sysclk_ahb_prescaler_t ahb_pres,
                    rcc_sysclk_apb_prescaler_t apb1_pres,
                    rcc_sysclk_apb_prescaler_t apb2_pres);
...
void rcc_sysclk_set_mco(rcc_sysclk_mco_clock_t clock,
                        rcc_sysclk_mco_pre_t prescaler);
